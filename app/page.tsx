...
export default function AuthPage() {
  return (
    <div className="grid min-h-screen w-full lg:grid-cols-[1fr_400px] bg-background bg-black">
      <div className="hidden lg:flex items-center justify-center bg-muted/10 p-8">
      <div className="relative w-full max-w-2xl">
        <div className="space-y-4">
        <h1 className="text-4xl font-bold tracking-tight text-card lg:text-6xl">Deeptrack</h1>
